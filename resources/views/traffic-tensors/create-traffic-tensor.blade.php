                                    ...
                                    <select name="poles[]" id="poles">
                                        ...
                                        @if ($traffic_poles)
                                            @foreach($traffic_poles as $traffic_pole)
                                                <option value="{{ $traffic_pole->id }}" {{ old('poles') == $traffic_pole->id ? 'selected' : '' }}>{{ $traffic_pole->code }} | {{ $traffic_pole->intersection->main_st }} y {{ $traffic_pole->intersection->cross_st }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
