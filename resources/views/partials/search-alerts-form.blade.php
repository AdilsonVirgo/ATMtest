<div class="row">
    <div class="col-sm-8 offset-sm-4 col-md-6 offset-md-6 col-lg-5 offset-lg-7 col-xl-4 offset-xl-8">
        {!! Form::open(['route' => 'search-alerts', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_alerts']) !!}
            {!! csrf_field() !!}
            <div class="input-group mb-3">
                {!! Form::text('alert_search_box', NULL, ['id' => 'alert_search_box', 'class' => 'form-control', 'placeholder' => trans('verticalsignals.search.search-alerts-ph'), 'aria-label' => trans('verticalsignals.search.search-alerts-ph'), 'required' => false]) !!}
